...
router.post('/profile-image', authUser, userIdValidator, upload.single('profileImage'), uploadProfileImage);
router.delete('/profile-image', authUser, userIdValidator, deleteProfileImage);
